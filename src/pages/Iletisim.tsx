...
export default function Iletisim() {
  ...
  // Form Gönderimi (FormEvent ve e.preventDefault() olmadan, onClick ile tetiklenir)
  const handleSubmit = () => {
    if (validate()) {
      setIsSubmitted(true);
  ...
  return (
    <div style={{ maxWidth: '600px', margin: '0 auto' }}>
      ...
      {/* form etiketi yerine div kullanılarak sayfa yenilenmesi önlendi */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
        ...
        <button type="button" onClick={handleSubmit} style={{ padding: '10px 20px', cursor: 'pointer' }}>
          Gönder 
        </button>
      </div>
    </div>
